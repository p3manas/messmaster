...
public final class common_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("function getAjaxService(mydata, urlStr, callbackOperation, target, id, name){\r\n");
      out.write("\t$.ajax({\t\t\t   \t\t\r\n");
      out.write("   \t\ttype\t: 'GET',\r\n");
      ...
      out.write("\t\t\tcallbackOperation(data, target, id, name);\r\n");
      out.write("   \t\t},\t\t   \t\t\r\n");
      out.write("   \t\terror: function(xhr, tStatus, err) {\r\n");
      out.write("   \t\t\t$.messager.alert('");
      if (_jspx_meth_spring_005fmessage_005f0(_jspx_page_context))
        return;
      out.write("', xhr.status);\r\n");
      out.write("   \t\t\tif(xhr.status == 401){ // illegal access\r\n");
      out.write("   \t\t\t\t$.messager.alert('");
      ...
      out.write("');\r\n");
      out.write("   \t\t\t}\r\n");
      out.write("   \t\t\tif(xhr.status == 406){ // illegal access\r\n");
      out.write("   \t\t\t\t$.messager.alert('");
      ...
      out.write("');\r\n");
      out.write("   \t\t\t}\r\n");
      out.write("   \t\t\telse if(xhr.status == 408){ // request time out\r\n");
      out.write("   \t\t\t\t$.messager.alert('");
      ...
      out.write("');\r\n");
      out.write("   \t\t\t}\r\n");
      out.write("   \t\t\telse if(xhr.status == 500){ // internal server error\r\n");
      out.write("   \t\t\t\t$.messager.alert('");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function postAjaxService(mydata, urlStr, callbackOperation, target){\r\n");
      out.write("\t$.ajax({\t\t\t   \t\t\r\n");
      out.write("   \t\ttype\t: 'POST',\r\n");
      out.write("   \t\turl\t\t: urlStr,\r\n");
      out.write("   \t\tdata\t: mydata,\r\n");
      ...
      out.write("   \t\t},\r\n");
      out.write("   \t\tsuccess : function(data) {\r\n");
      out.write("\t\t\tcallbackOperation(data, target);\r\n");
      out.write("   \t\t},\t\t   \t\t\r\n");
      out.write("   \t\terror: function(xhr, tStatus, err) {\r\n");
      out.write("   \t\t\t$.messager.alert('");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function searchListAjaxService(mydata, urlStr, target){\r\n");
      out.write("\tpostAjaxService(mydata, urlStr, updatesearchList, target);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function updatesearchList(data, target){\r\n");
      out.write("\t$('#' + target).datagrid({pageNumber: 1});\r\n");
      out.write("\t$('#' + target).datagrid('getPager').pagination({showRefresh:false});\r\n");
      out.write("\t$('#' + target).datagrid('loadData', data);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function selectOptionsAjaxService(mydata, urlStr, target){\r\n");
      out.write("\tselectOptionsAjaxServiceWithId(mydata, urlStr, target, \"id\", \"name\");\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function selectOptionsAjaxServiceWithId(mydata, urlStr, target, id, name){\r\n");
      out.write("\tgetAjaxService(mydata, urlStr, updateOptionsData, target, id, name)\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function updateOptionsData(data, target, id, name){\r\n");
      out.write("\tremoveOptions(target);\r\n");
      out.write("\t$.each(data, function(i, arr) {\r\n");
      out.write("        $('#' + target).append($('<option>').text(arr[name]).attr('value', arr[id]).attr('class', 'formdd'));\r\n");
      out.write("    });\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function removeOptions(target){\r\n");
      out.write("\t$('#' + target)\r\n");
      out.write("    .find('option')\r\n");
      out.write("    .remove()\r\n");
      out.write("    .end();\r\n");
      out.write("\t$('#' + target).append($('<option>').text('");
      if (_jspx_meth_spring_005fmessage_005f22(_jspx_page_context))
        return;
      out.write("').attr('value', '').attr('class', 'formdd'));\r\n");
      out.write("}\r\n");
      out.write("function removeMsg(){\r\n");
      out.write("\t$(\"#pageerrormsg\").html('');\r\n");
      out.write("\t$(\"#pagsuccessmsg\").html('');\r\n");
      out.write("}\r\n");
      out.write("</script>");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_spring_005fmessage_005f0(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(18,24) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f0.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f1(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(20,25) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f1.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f2(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(20,65) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f2.setCode("unauthrized.access.errmsg");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f3(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(23,25) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f3.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f4(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(23,65) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f4.setCode("illigal.access.errmsg");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f5(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(26,25) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f5.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f6(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(26,65) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f6.setCode("request.timeout.errmsg");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f7(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(29,25) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f7.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f8(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(29,65) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f8.setCode("internal.server.errmsg");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f9(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(32,25) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f9.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f10(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(32,65) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f10.setCode("unknown.errmsg");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f11(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(52,24) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f11.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f12(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(54,25) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f12.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f13(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(54,65) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f13.setCode("unauthrized.access.errmsg");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f14(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(57,25) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f14.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f15(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(57,65) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f15.setCode("illigal.access.errmsg");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f16(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(60,25) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f16.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f17(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(60,65) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f17.setCode("request.timeout.errmsg");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f18(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(63,25) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f18.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f19(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(63,65) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f19.setCode("internal.server.errmsg");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f20(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(66,25) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f20.setCode("warning.lbl");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f21(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(66,65) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f21.setCode("unknown.errmsg");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f22(PageContext _jspx_page_context)
    ...
    // /pages/common.jsp(102,44) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f22.setCode("please.select.lbl");
